...
public class WalletService {
    ...
    public void updateWallet(String message) throws JsonProcessingException {
        ...
        if (fromUserWallet.getBalance() >= transactionAmount) {
            ...
            //Write it as h.w
            int fromUserWalletBalance = fromUserWallet.getBalance();
            fromUserWallet.setBalance(fromUserWalletBalance - transactionAmount);
            walletRepository.save(fromUserWallet);

            int toUserWalletBalance = receiverWallet.getBalance();
            receiverWallet.setBalance(toUserWalletBalance + transactionAmount);
